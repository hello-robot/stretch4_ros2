...
def generate_launch_description():
    ...
    default_config = PathJoinSubstitution([pkg, 'config', 'line_sensors.yaml'])
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('publish_raw_scans', default_value='false', choices=['true', 'false']),
        ...
        Node(
            ...
            parameters=[
                LaunchConfiguration('config_file'),
                {
                    ...
                    'publish_raw_scans': ParameterValue(LaunchConfiguration('publish_raw_scans'), value_type=bool),
