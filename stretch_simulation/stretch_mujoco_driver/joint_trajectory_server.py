    ...
    def execute_callback(self, goal_handle):
        ...
        for point in trajectory.points:
            ...
            for i, joint in enumerate(joint_names):
                ...
                if (actuator == Actuators.left_wheel_vel or actuator == Actuators.right_wheel_vel or actuator == Actuators.back_wheel_vel) and velocity is not None:
                    self.node.sim.set_base_velocity(velocity, 0, 0)
                    continue
            ...
            for actuator in [Actuators.left_wheel_vel, Actuators.right_wheel_vel, Actuators.back_wheel_vel]:
